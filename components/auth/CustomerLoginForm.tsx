...
import { UserCircle, Eye, EyeOff, Loader2, AlertCircle } from "lucide-react";
...
export default function CustomerLoginForm() {
  ...
  const onSubmit = async (data: LoginFormData) => {
    ...
    try {
      ...
      if (result?.error) {
        if (result.error.includes("not verified") || result.error.includes("PENDING")) {
          setError("Your account has not been verified yet. Please wait for KYC verification.");
        } else {
